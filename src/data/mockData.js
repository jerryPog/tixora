...
export const COMMISSION_TIERS = [
  {
    ...
    perks: ["Digital Campus Promoter ID", "Basic Credit Line (50 tickets)", "WhatsApp Promoter Group Access", "Instant QR Pass Issuance"],
  ...
  },
  {
    ...
    perks: ["Expanded Credit Line (100 tickets)", "Priority Artist Guestlist Access", "Early Access to Phase 1 allocations", "Dedicated Festival Ops Manager"],
  ...
  },
  {
    ...
    perks: ["Max Uncapped Credit Line (200+ tickets)", "All-Access Backstage / Artist Lounge Pass", "Direct Event Organizer Partner Share", "End-of-Tour Cash Bonus"],
